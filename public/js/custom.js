...
/* Main page isotope */
function isotope(isotopeContainerId) {
    var $container = $('#' + isotopeContainerId);
    var item = $('#' + isotopeContainerId + ' .element');
    var columns;
    var width;
...
$(document).ready(function () {
    var isotopeContainerId = $('#gallery').length ? 'gallery' : ($('#portfolio-one').length ? 'portfolio-one' : false);

    if (isotopeContainerId) {
        isotope(isotopeContainerId); // Initilize isotope
        $(window).smartresize(function () {
            isotope(isotopeContainerId); // Call isotope when resize
        });
        ...
        if ($('#filters a').length) {
            $('#filters a').click(function () {
                ...
                $('#' + isotopeContainerId).isotope({ filter: selector });
                return false;
            });
        }
    }
